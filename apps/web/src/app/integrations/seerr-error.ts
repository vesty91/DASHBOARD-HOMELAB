...
export function seerrUserError(error: unknown): string {
  ...
  switch (code) {
    ...
    case "TLS_ERROR":
      return "Erreur TLS vers Seerr. Vérifiez le certificat ou la CA de confiance.";
    case "UNREACHABLE":
      return "Le serveur Seerr est injoignable.";
    case "FORBIDDEN":
      return "Accès Seerr refusé.";
    case "UNAUTHORIZED":
    ...
    default:
      ...
      return "Seerr est indisponible. Vérifiez l'URL et la clé API.";
  }
}
