...
export const SONARR_REFRESH_RATE_LIMIT = 10;
export const SONARR_REFRESH_RATE_WINDOW_MS = 60_000;
export const SONARR_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemorySonarrRateLimiter implements IntegrationRateLimiter {
...
export class MemorySonarrRefreshRateLimiter extends MemorySonarrRateLimiter {
  constructor(
    limit = SONARR_REFRESH_RATE_LIMIT,
    windowMs = SONARR_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = SONARR_REFRESH_MAX_TRACKED_KEYS,
  ) {
