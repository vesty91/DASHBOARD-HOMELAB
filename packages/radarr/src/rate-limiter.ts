...
export const RADARR_REFRESH_RATE_LIMIT = 10;
export const RADARR_REFRESH_RATE_WINDOW_MS = 60_000;
export const RADARR_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryRadarrRateLimiter implements IntegrationRateLimiter {
...
export class MemoryRadarrRefreshRateLimiter extends MemoryRadarrRateLimiter {
  constructor(
    limit = RADARR_REFRESH_RATE_LIMIT,
    windowMs = RADARR_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = RADARR_REFRESH_MAX_TRACKED_KEYS,
  ) {
