...
export const NTFY_REFRESH_RATE_LIMIT = 10;
export const NTFY_REFRESH_RATE_WINDOW_MS = 60_000;
export const NTFY_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryNtfyRateLimiter implements IntegrationRateLimiter {
...
export class MemoryNtfyRefreshRateLimiter extends MemoryNtfyRateLimiter {
  constructor(
    limit = NTFY_REFRESH_RATE_LIMIT,
    windowMs = NTFY_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = NTFY_REFRESH_MAX_TRACKED_KEYS,
  ) {
