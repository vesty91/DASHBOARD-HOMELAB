...
export const UPTIME_KUMA_OVERVIEW_CACHE_PREFIX = "uptime-kuma.overview";

export function uptimeKumaOverviewCacheOperation(
  ...
  const digest = createHash("sha256")
    ...
    .digest("hex");
  return `${UPTIME_KUMA_OVERVIEW_CACHE_PREFIX}:${digest}`;
}
