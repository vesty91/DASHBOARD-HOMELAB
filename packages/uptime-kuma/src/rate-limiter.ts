...
export const UPTIME_KUMA_REFRESH_RATE_LIMIT = 10;
export const UPTIME_KUMA_REFRESH_RATE_WINDOW_MS = 60_000;
export const UPTIME_KUMA_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryUptimeKumaRateLimiter implements IntegrationRateLimiter {
...
export class MemoryUptimeKumaRefreshRateLimiter extends MemoryUptimeKumaRateLimiter {
  constructor(
    limit = UPTIME_KUMA_REFRESH_RATE_LIMIT,
    windowMs = UPTIME_KUMA_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = UPTIME_KUMA_REFRESH_MAX_TRACKED_KEYS,
  ) {
