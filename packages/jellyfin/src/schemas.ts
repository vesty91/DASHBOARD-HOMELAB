...
const jellyfinApiKeySchema = z
  .string()
  .min(1)
  .max(512)
  .refine((value) => !/[^\u0021-\u007E]/u.test(value), "Jellyfin API key must be visible ASCII");
...
export const jellyfinSecretSchema = z.object({
  apiKey: jellyfinApiKeySchema,
});

export const jellyfinIntegrationInputSchema = z.object({
  integrationId: z.uuid(),
});

export type JellyfinConfig = z.infer<typeof jellyfinConfigSchema>;
export type JellyfinSecrets = z.infer<typeof jellyfinSecretSchema>;
