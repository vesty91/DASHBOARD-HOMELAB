...
export const JELLYFIN_REFRESH_RATE_LIMIT = 10;
export const JELLYFIN_REFRESH_RATE_WINDOW_MS = 60_000;
export const JELLYFIN_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryJellyfinRateLimiter implements IntegrationRateLimiter {
...
export class MemoryJellyfinRefreshRateLimiter extends MemoryJellyfinRateLimiter {
  constructor(
    limit = JELLYFIN_REFRESH_RATE_LIMIT,
    windowMs = JELLYFIN_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = JELLYFIN_REFRESH_MAX_TRACKED_KEYS,
  ) {
