...
export const QBITTORRENT_OVERVIEW_CACHE_PREFIX = "qbittorrent.overview";

export function qbittorrentOverviewCacheOperation(
  ...
  const digest = createHash("sha256")
    ...
    .digest("hex");
  return `${QBITTORRENT_OVERVIEW_CACHE_PREFIX}:${digest}`;
}
