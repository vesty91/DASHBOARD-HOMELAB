...
export const QBITTORRENT_REFRESH_RATE_LIMIT = 10;
export const QBITTORRENT_REFRESH_RATE_WINDOW_MS = 60_000;
export const QBITTORRENT_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryQbittorrentRateLimiter implements IntegrationRateLimiter {
...
export class MemoryQbittorrentRefreshRateLimiter extends MemoryQbittorrentRateLimiter {
  constructor(
    limit = QBITTORRENT_REFRESH_RATE_LIMIT,
    windowMs = QBITTORRENT_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = QBITTORRENT_REFRESH_MAX_TRACKED_KEYS,
  ) {
