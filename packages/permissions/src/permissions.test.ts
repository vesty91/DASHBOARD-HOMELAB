...
describe("permission resolver", () => {
  ...
  it("does not grant Docker, Synology, Jellyfin, Immich, Beszel, Prometheus, Uptime Kuma, Proxmox, Grafana, ntfy, Sonarr or Radarr permissions to the default ADMIN role", () => {
