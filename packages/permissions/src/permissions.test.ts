...
describe("permission resolver", () => {
  ...
  it("does not grant Docker, Synology, Jellyfin, Immich, Beszel, Prometheus, Uptime Kuma, Proxmox, Grafana, ntfy, Sonarr, Radarr or Prowlarr permissions to the default ADMIN role", () => {
