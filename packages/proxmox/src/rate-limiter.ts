...
export const PROXMOX_REFRESH_RATE_LIMIT = 10;
export const PROXMOX_REFRESH_RATE_WINDOW_MS = 60_000;
export const PROXMOX_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryProxmoxRateLimiter implements IntegrationRateLimiter {
...
export class MemoryProxmoxRefreshRateLimiter extends MemoryProxmoxRateLimiter {
  constructor(
    limit = PROXMOX_REFRESH_RATE_LIMIT,
    windowMs = PROXMOX_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = PROXMOX_REFRESH_MAX_TRACKED_KEYS,
  ) {
