...
export const CUSTOM_API_REFRESH_RATE_LIMIT = 10;
export const CUSTOM_API_REFRESH_RATE_WINDOW_MS = 60_000;
export const CUSTOM_API_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryCustomApiRateLimiter implements IntegrationRateLimiter {
...
export class MemoryCustomApiRefreshRateLimiter extends MemoryCustomApiRateLimiter {
  constructor(
    limit = CUSTOM_API_REFRESH_RATE_LIMIT,
    windowMs = CUSTOM_API_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = CUSTOM_API_REFRESH_MAX_TRACKED_KEYS,
  ) {
