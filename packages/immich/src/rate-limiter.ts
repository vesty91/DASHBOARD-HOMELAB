...
export const IMMICH_REFRESH_RATE_LIMIT = 10;
export const IMMICH_REFRESH_RATE_WINDOW_MS = 60_000;
export const IMMICH_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryImmichRateLimiter implements IntegrationRateLimiter {
...
export class MemoryImmichRefreshRateLimiter extends MemoryImmichRateLimiter {
  constructor(
    limit = IMMICH_REFRESH_RATE_LIMIT,
    windowMs = IMMICH_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = IMMICH_REFRESH_MAX_TRACKED_KEYS,
  ) {
