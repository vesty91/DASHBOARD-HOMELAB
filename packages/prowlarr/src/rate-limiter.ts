...
export const PROWLARR_REFRESH_RATE_LIMIT = 10;
export const PROWLARR_REFRESH_RATE_WINDOW_MS = 60_000;
export const PROWLARR_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryProwlarrRateLimiter implements IntegrationRateLimiter {
...
export class MemoryProwlarrRefreshRateLimiter extends MemoryProwlarrRateLimiter {
  constructor(
    limit = PROWLARR_REFRESH_RATE_LIMIT,
    windowMs = PROWLARR_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = PROWLARR_REFRESH_MAX_TRACKED_KEYS,
  ) {
