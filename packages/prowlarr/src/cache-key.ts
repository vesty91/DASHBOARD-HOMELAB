...
export const PROWLARR_OVERVIEW_CACHE_PREFIX = "prowlarr.overview";

export function prowlarrOverviewCacheOperation(
  ...
  const digest = createHash("sha256")
    ...
    .digest("hex");
  return `${PROWLARR_OVERVIEW_CACHE_PREFIX}:${digest}`;
}
