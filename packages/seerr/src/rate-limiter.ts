...
export const SEERR_REFRESH_RATE_LIMIT = 10;
export const SEERR_REFRESH_RATE_WINDOW_MS = 60_000;
export const SEERR_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemorySeerrRateLimiter implements IntegrationRateLimiter {
...
export class MemorySeerrRefreshRateLimiter extends MemorySeerrRateLimiter {
  constructor(
    limit = SEERR_REFRESH_RATE_LIMIT,
    windowMs = SEERR_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = SEERR_REFRESH_MAX_TRACKED_KEYS,
  ) {
