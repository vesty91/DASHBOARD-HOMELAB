...
export const BESZEL_REFRESH_RATE_LIMIT = 10;
export const BESZEL_REFRESH_RATE_WINDOW_MS = 60_000;
export const BESZEL_REFRESH_MAX_TRACKED_KEYS = 10_000;

class MemoryBeszelRateLimiter implements IntegrationRateLimiter {
...
export class MemoryBeszelRefreshRateLimiter extends MemoryBeszelRateLimiter {
  constructor(
    limit = BESZEL_REFRESH_RATE_LIMIT,
    windowMs = BESZEL_REFRESH_RATE_WINDOW_MS,
    now: () => number = () => Date.now(),
    maxTrackedKeys = BESZEL_REFRESH_MAX_TRACKED_KEYS,
  ) {
