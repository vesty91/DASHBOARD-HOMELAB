...
Dashboard self-hosted pour homelab et NAS. Version **1.8.0**.
...
Images GHCR (après publication du tag `v1.8.0`) :
...
`APP_VERSION=1.8.0`, puis `docker compose pull && docker compose up`.
