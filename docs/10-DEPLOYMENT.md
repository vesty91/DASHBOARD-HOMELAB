...
La version applicative publiée est `1.8.1` (Phase 29 patch, tag `v1.8.1`).
Elle inclut les hotfixes E2E `#102` / `#103` absents de `v1.8.0`. Ne jamais
déplacer `v1.8.0` ni `v1.8.1`. Les tags `phase-*` ne
...
2. Lire `CHANGELOG.md`. Migrations `0000`–`0015` sont immuables une fois
   ...
   backup 13 ; il inclut les hotfixes E2E post-`v1.8.0` (`#102` / `#103`) et
   les stabilisations Phase 29. Remplacer les quatre images au tag `1.8.1` ;
   ne pas retagger `v1.8.0`.
